...
- [0001-home-as-daily-pick.md](0001-home-as-daily-pick.md): ホームをスコアリング抽選の「今日の一店」にする
...
- [0005-decision-engine-scope.md](0005-decision-engine-scope.md): 決定エンジンの MVP スコープ（gacha / swipe / roulette）
